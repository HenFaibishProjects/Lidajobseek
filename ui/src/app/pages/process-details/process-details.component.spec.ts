...
import { LucideAngularModule, Briefcase, ExternalLink, Mail, Phone, Calendar, MapPin, Globe, Clock, Target, Rocket, Heart, Sparkles, Send, CheckCircle, Clock4, FileText, ChevronRight, X, MessageSquare, Plus, History, Lightbulb, Trash2, Edit2, AlertCircle, Pencil, Edit, CheckCircle2, Users } from 'lucide-angular';
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [
        ...
        RouterTestingModule,
        LucideAngularModule.pick({ Briefcase, ExternalLink, Mail, Phone, Calendar, MapPin, Globe, Clock, Target, Rocket, Heart, Sparkles, Send, CheckCircle, Clock4, FileText, ChevronRight, X, MessageSquare, Plus, History, Lightbulb, Trash2, Edit2, AlertCircle, Pencil, Edit, CheckCircle2, Users })
      ],
      providers: [
        {
